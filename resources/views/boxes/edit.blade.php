<x-app-layout>
    <div class="abc-page-header">
            <div class="flex justify-between items-center relative z-10">
                <div>
                    <h2 class="text-2xl font-bold tracking-tight">Editar Caja: {{ $box->box_number }}</h2>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="abc-card">
                ...
                <form method="POST" action="{{ route('boxes.update', $box) }}" class="p-6 space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="box_number" id="box_number" value="{{ old('box_number', $box->box_number) }}"
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="abc-input">{{ old('description', $box->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
