    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="abc-filter-bar">
                <form method="GET" action="{{ route('notes.index') }}" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 items-end">
                    <div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full" style="min-width: 900px;">
                        ...
                        <tbody class="divide-y" style="border-color: var(--surface-border-light);">
                            ...
                            @empty
                                <tr>
                                    <td colspan="10" class="text-center py-16" style="border: none;">
