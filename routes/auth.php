...
Route::middleware('guest')->group(function () {
    ...
    // Password Reset con código de verificación
    Route::get('forgot-password', [PasswordResetCodeController::class, 'showForgotForm'])
    ...
    Route::get('reset-password', [PasswordResetCodeController::class, 'showResetForm'])
