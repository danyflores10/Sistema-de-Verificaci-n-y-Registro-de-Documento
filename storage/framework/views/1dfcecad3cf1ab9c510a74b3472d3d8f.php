...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                    <a class="text-sm text-blue-600 hover:text-blue-800 font-medium" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\hp pavilion\OneDrive\Escritorio\System Correos\system-correos\resources\views/auth/login.blade.php ENDPATH**/ ?>