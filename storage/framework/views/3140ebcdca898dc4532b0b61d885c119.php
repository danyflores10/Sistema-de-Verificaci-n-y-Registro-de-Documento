    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="abc-card">
                ...
                <form method="POST" action="<?php echo e(route('users.store')); ?>" class="p-6 space-y-5">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <select name="role" id="role" required class="abc-input">
                            <option value="USUARIO" <?php if(old('role') === 'USUARIO'): echo 'selected'; endif; ?>>USUARIO</option>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp pavilion\OneDrive\Escritorio\System Correos\system-correos\resources\views/users/create.blade.php ENDPATH**/ ?>