                    ...
                    <div class="px-5 py-4">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-3">
                            <div class="flex items-center gap-4">
                                <div class="w-11 h-11 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 <?php echo e($user->is_active ? 'gradient-navy' : 'bg-gray-400'); ?>">
                                    <?php echo e(strtoupper(substr($user->name, 0, 2))); ?>

                                </div>
                                <div>
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <span class="font-semibold text-base" style="color: var(--text-primary)"><?php echo e($user->name); ?></span>
                                    ...
                                    <p class="text-xs mt-0.5" style="color: var(--text-muted)"><?php echo e($user->email); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
