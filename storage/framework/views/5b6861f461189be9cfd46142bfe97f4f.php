                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm import-map-table min-w-[980px]">
                            ...
                            <tbody class="divide-y" style="border-color: var(--surface-border);">
                                ...
                                <tr><td class="py-2 px-3 font-mono text-xs">D — N° DE DOCUMENTO</td><td class="py-2 px-3">N. de CITE</td><td class="py-2 px-3"><span class="text-gray-400 font-bold text-xs">NO</span></td></tr>
