    ...
    <form method="post" action="<?php echo e(route('profile.update')); ?>" class="space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input id="name" name="name" type="text" class="abc-input mt-1.5" value="<?php echo e(old('name', $user->name)); ?>" required autofocus autocomplete="name" placeholder="Ingresa tu nombre completo" />
...
<?php endif; ?>
            ...
            <div>
                ...
                <input id="email" name="email" type="email" class="abc-input mt-1.5" value="<?php echo e(old('email', $user->email)); ?>" required autocomplete="username" placeholder="correo@ejemplo.com" />
                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                    <div class="mt-2 p-3 rounded-lg bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-800">
                        <p class="text-sm text-amber-800 dark:text-amber-300 flex items-center gap-2">
                            ...
                            <span>
                                ...
                                <button form="send-verification" class="underline font-medium hover:text-amber-600 dark:hover:text-amber-200 transition">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('status') === 'verification-link-sent'): ?>
                            <p class="mt-2 font-medium text-sm text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
...
<?php /**PATH C:\Users\hp pavilion\OneDrive\Escritorio\System Correos\system-correos\resources\views\profile\partials\update-profile-information-form.blade.php ENDPATH**/ ?>