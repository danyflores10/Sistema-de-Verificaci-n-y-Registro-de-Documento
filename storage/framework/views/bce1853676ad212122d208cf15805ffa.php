    ...
    <div class="abc-page-header">
            <div class="flex justify-between items-center relative z-10">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold tracking-tight">Editar Usuario: <?php echo e($user->name); ?></h2>
                        <p class="text-white/70 text-sm mt-1">Modificar datos de la cuenta seleccionada</p>
                    </div>
                </div>
                <a href="<?php echo e(route('users.index')); ?>" class="abc-btn abc-btn-ghost !bg-white/10 !text-white hover:!bg-white/20">
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="abc-card">
                ...
                <form method="POST" action="<?php echo e(route('users.update', $user)); ?>" class="p-6 space-y-5">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <select name="role" id="role" required class="abc-input">
                            <option value="USUARIO" <?php if(old('role', $user->role) === 'USUARIO'): echo 'selected'; endif; ?>>USUARIO</option>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp pavilion\OneDrive\Escritorio\System Correos\system-correos\resources\views\users\edit.blade.php ENDPATH**/ ?>