...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="tipologia" id="tipologia"
                                   value="<?php echo e(old('tipologia', $note->tipologia)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="estado_conservacion" id="estado_conservacion"
                                   value="<?php echo e(old('estado_conservacion', $note->estado_conservacion)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-5">
                        ...
                        <textarea name="observations" id="observations" rows="2"
                                  class="abc-input" placeholder="Observaciones adicionales..."><?php echo e(old('observations', $note->observations)); ?></textarea>
                    </div>
                    ...
                    <div class="mt-5" x-data="fileUpload({ maxMB: 500 })">
                        ...
                        <div class="mt-1 border-2 border-dashed rounded-xl p-6 text-center transition-all duration-200 cursor-pointer"
                            ...
                            <p class="text-xs mt-1" style="color: var(--text-muted);">PDF, JPG, PNG &mdash; Máximo <?php echo e(Auth::user()->isAdmin() ? '500' : '200'); ?>MB por archivo</p>
